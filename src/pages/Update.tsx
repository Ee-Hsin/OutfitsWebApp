...
const Update = () => {
    ...
    const item: ClosetItem = location.state?.item
    const {
        register,
        handleSubmit,
        formState: { errors },
        ...
        defaultValues: {
            ...
            color: item.color,
            hasGraphic: item.hasGraphic ? 'yesGraphic' : 'noGraphic',
        },
    })
    const updateItem = useUpdateItem()

    const selectedCategory: ClothingCategory = watch(
        'category'
    ) as ClothingCategory
    ...
    const onSubmit: SubmitHandler<ClosetItem> = (data: ClosetItem) => {
        ...
        updateItem.mutate({ details: { ...data }, itemId: item._id })
        reset()
    }
    ...
    return (
        <div>
            ...
            {updateItem.isSuccess && <Navigate to="/app/closet" />}
            <form
                    ...
                    <>
                        ...
                        <div className="flex-col w-[320px] sm:w-[455px] sm:mx-10">
                            <div className="flex py-3 sm:py-6 items-center">
                                ...
                                <div className=" w-24 sm:w-32 text-lg">
                                    Name:
                                </div>
                                <input
                                    type="text"
                            ...
                            <div className="flex py-5 sm:py-6 items-center">
                                ...
                                <div className="w-20 sm:w-32 text-lg">
                                    Type:
                                </div>
                                <select
                                    id="firstSelect"
                            ...
                            <div className="flex py-5 sm:py-6 items-center">
                                ...
                                <div className="w-28 sm:w-32 text-lg">
                                    Color:
                                </div>
                                <select
